...
class Application {
  ...
  public static void main(String[] args) {
    SegmentSearcher segmentSearcher = SegmentSearcher.createFromString(DAY8_INPUT);
    System.out.println(segmentSearcher.getAmountOfUniqueNumbers());
    System.out.println(segmentSearcher.decodeAndSumAllOutputValues());
  }

  private static final String DAY8_INPUT =
